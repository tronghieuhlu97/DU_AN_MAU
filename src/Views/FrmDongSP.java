...
public class FrmDongSP extends javax.swing.JFrame {
    ...
    private void tblDongSPMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDongSPMouseClicked
        ...
        txtMa.setText(tblDongSP.getValueAt(row, 1).toString());
        txtTen.setText(tblDongSP.getValueAt(row, 2).toString());
    ...
    private void btnADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnADDActionPerformed
        ...
        if (hoi == JOptionPane.YES_OPTION) {
            for (int i = 0; i < lstQLDongSP.size(); i++) {
                if (txtMa.getText().equalsIgnoreCase(lstQLDongSP.get(i).getMa())) {
                    JOptionPane.showMessageDialog(this, "Mã sản phẩm bị trùng");
                    return;
                }
            }
            JOptionPane.showMessageDialog(this, _iManageDongSPService.add(getQLDongSPFromInput()));
            loadDataToTable();
        }
    ...
    private void btnEDITActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEDITActionPerformed
        ...
        if (hoi == JOptionPane.YES_OPTION) {
           for(int i = 0;i<lstQLDongSP.size();i++){
               if(row != i && lstQLDongSP.get(i).getMa().equalsIgnoreCase(txtMa.getText())){
                   JOptionPane.showMessageDialog(this, "Mã đã tồn tại");
                   return;
               }
           }
           JOptionPane.showMessageDialog(this, _iManageDongSPService.update(getID(),getQLDongSPFromInput()));
           loadDataToTable();
        }
    ...
    private void btnDELETEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDELETEActionPerformed
        ...
        if (hoi == JOptionPane.YES_OPTION) {
            JOptionPane.showMessageDialog(this, _iManageDongSPService.delete(getID()));
            loadDataToTable();
        }
    ...
    private void loadDataToTable() {
        lstQLDongSP = _iManageDongSPService.getAll();
        dtm = (DefaultTableModel) tblDongSP.getModel();
        dtm.setRowCount(0);
        for (QLDongSP x : lstQLDongSP) {
            dtm.addRow(new Object[]{lstQLDongSP.indexOf(x) + 1, x.getMa(), x.getTen()});
        }

    }

    private QLDongSP getQLDongSPFromInput() {
        return new QLDongSP(txtMa.getText(), txtTen.getText());
    }

   private String getID(){
       int index = tblDongSP.getSelectedRow();
       return lstQLDongSP.get(index).getId();
   }
}
