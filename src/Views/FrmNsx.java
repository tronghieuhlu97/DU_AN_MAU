...
public class FrmNsx extends javax.swing.JFrame {
    ...
    private void btnADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnADDActionPerformed
        ...
        if (hoi == JOptionPane.YES_OPTION) {
            for (int i = 0; i < lstQLNsx.size(); i++) {
                if (lstQLNsx.get(i).getMa().equalsIgnoreCase(txtMa.getText())) {
                    JOptionPane.showMessageDialog(this, "Mã ko đc trùng");
                    return;
                }
            }
          
                 JOptionPane.showMessageDialog(this, _iManageNsxService.add(getQLNsxFromInput()));
            loadDataToTable();
    ...
    private void btnEDITActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEDITActionPerformed
        ...
        if (hoi == JOptionPane.YES_OPTION) {
            for (int i = 0; i < lstQLNsx.size(); i++) {
                if (i != row && lstQLNsx.get(i).getMa().equalsIgnoreCase(txtMa.getText())) {
                    JOptionPane.showMessageDialog(this, "Mã đã tồn tại");
                    return;
                }
            }
            try {
                JOptionPane.showMessageDialog(this, _iManageNsxService.edit(getID(), getQLNsxFromInput()));
                loadDataToTable();
            } catch (Exception e) {
    ...
    private void btnDELETEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDELETEActionPerformed
        ...
        if (hoi == JOptionPane.YES_OPTION) {
            try {
                JOptionPane.showMessageDialog(this, _iManageNsxService.delete(getID()));
                loadDataToTable();
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, "Mời chọn lại");
            }
    ...
    private void loadDataToTable() {
        ...
        for (QLNSX x : lstQLNsx) {
            dtm.addRow(new Object[]{lstQLNsx.indexOf(x) + 1, x.getMa(), x.getTen()});
        }
    }

    private QLNSX getQLNsxFromInput() {
        return new QLNSX(txtMa.getText(), txtTen.getText());
    }

    private String getID() {
        int index = tblNsx.getSelectedRow();
        return lstQLNsx.get(index).getId();
    }
}
